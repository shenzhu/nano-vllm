...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        # Split qkv into independent Query, Key and Value tensors,
        # self.q_size and self.kv_size might be different with Grouped_query Attention
        #
        ...
        # RoPE will not change the dimensions
